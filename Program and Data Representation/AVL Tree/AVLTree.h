...
class AVLTree {
 ...
 private:
  ...
  bool find2(const string& x, AVLNode* n) const;
  string path2(const string& x, AVLNode* n) const;
  int counter(AVLNode* n)const;
  void inserting(const string& x, AVLNode*& n);
};
