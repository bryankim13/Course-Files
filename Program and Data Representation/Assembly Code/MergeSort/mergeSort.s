...
; Parameter 2 is the left index in the array rsi l
; Parameter 3 is the right index in the array rdx r
; Return type is void 
mergeSort:

	; Implement mergeSort here
	cmp 	rsi, rdx	;if(i1=i2)
	je 		mend
	...
	push	r10	
	push 	rsi
	mov 	rdx, r10 	;rdx = r10 = mid
	call 	mergeSort 	;pointer, head, mid
	pop 	rsi
	pop 	r10
	pop 	rdx			
	push 	rsi 		;saves rsi 
	mov 	rsi, r10 	;rsi = r10 = mid
	add		rsi, 1		;rsi += 1
	push 	r10
	push 	rdx
	call 	mergeSort 	;pointer, mid+1, end
	pop 	rdx
	pop 	r10
	pop 	rsi
	push 	rdx		
	mov 	rcx, rdx	;copy 4th parameter with rdx
	mov 	rdx, r10 	;rdx = mid
	push 	r10
	push 	rsi
	call  	merge
